...
import './GoodsPageMiddleText.css';
...
import  CoffeeProduct from '../../Coffe-page/CoffeePageMiddleText/coffee_products.svg'

class GoodsPageMiddleText extends Component {

	render() {
		return (
			<div>
				<div className='coffee-page-middle-text'>
					<div className='goods-page-middle-text-img'></div>
					<div className='coffee-page-middle'>
						<div className='coffee-page-middle-about'>About our beans</div>
						<CoffeeBeans />
...
export default GoodsPageMiddleText;